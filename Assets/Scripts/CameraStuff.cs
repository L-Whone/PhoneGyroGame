...
public class CameraStuff : MonoBehaviour
{
    ...
    {
        string filename = $"capture_{System.DateTime.Now:yyyMMdd__HHmmss}.png";
        ...
        using var intent = new AndroidJavaObject("android.content.Intent", "android.intent.action.MEDIA_FILE");
